  ...
  const cards = [
    {
      ...
      icon: "📝",
      description: "Record new grades for your subjects",
    ...
    },
    {
      ...
      icon: "👁️",
      description: "Check your grades and statistics",
    ...
    },
    {
      ...
      icon: "✏️",
      description: "Modify existing grade records",
    ...
    },
    {
      ...
      icon: "🗑️",
      description: "Remove outdated grade entries",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 flex flex-col p-4 sm:p-6 md:p-8">
      <div className="flex-grow flex flex-col max-w-7xl mx-auto w-full">
        ...
        >
          <p>Manage your academic grades with ease and efficiency.</p>
          <p className="mt-1">© 2025 Grade System</p>
        </motion.div>
      </div>
    </div>
  );
