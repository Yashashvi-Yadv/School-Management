...
export default function ViewAttendance() {
  ...
  // Fetch attendance by studentId + date or date range
  const fetchAttendance = async () => {
    ...
    try {
      const res = await axios.post(
        ...
        isRange
          ? { studentId: student._id, startDate: date, endDate }
      ...
      if (res.data.success) {
        ...
        setError(
          isRange
            ? "No attendance recorded for this student in the selected date range"
            : "No attendance recorded for this student on this date"
        );
      }
    } catch (err) {
      console.error(err);
      ...
      <div className="max-w-3xl mx-auto w-full">
        ...
        <AnimatePresence>
          {student && (
            ...
            >
              <div className="flex flex-col sm:flex-row sm:space-x-4 mb-3 space-y-2 sm:space-y-0">
                <motion.label
                ...
                >
                  ...
                  <motion.span
                    ...
                    animate={!isRange ? "checked" : "unchecked"}
                    whileHover="hover"
              ...
              <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
                ...
                <motion.button
                  ...
                  className="bg-gradient-to-r from-green-500 to-green-600 text-white py-2 px-4 sm:px-6 rounded-lg shadow-md hover:bg-green-700 transition-all text-sm sm:text-base"
                >
                  Get Attendance
                </motion.button>
              </div>
              ...
              {Array.isArray(attendance) ? (
                attendance.map((record, index) => (
                  <motion.p
                    ...
                    className="text-gray-800 mb-2 text-sm sm:text-base"
                  >
