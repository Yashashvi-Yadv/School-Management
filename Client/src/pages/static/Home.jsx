    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-indigo-50 via-white to-blue-50 font-sans">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 py-16 md:py-28 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-indigo-900 leading-tight mb-6 animate-fadeInDown tracking-tight">
            Empower Your School <br /> with Seamless Management 🎓
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mb-10 animate-fadeInUp delay-100 leading-relaxed">
            Streamline student, teacher, and class management with our intuitive,
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center text-gray-900 mb-12 relative before:content-[''] before:absolute before:left-1/2 before:-bottom-3 before:h-1.5 before:w-24 before:-translate-x-1/2 before:bg-indigo-500 before:rounded-full animate-fadeIn">
            Why Choose Us?
          </h2>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-10">
            ...
            >
              ...
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
                Effortlessly add, update, and monitor student records and academic
                performance.
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
                Seamlessly manage teacher profiles, subjects, and class assignments.
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
                Organize classes, sections, and subjects with ease and efficiency.
              </p>
            </Link>
          </div>
        </div>
